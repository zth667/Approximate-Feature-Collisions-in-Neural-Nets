...
vgg = vgg16(paras,'../../imgnet_32/imagenet_n03933933_1353_overlap.npz', '../vgg16_weights.npz', sess)
...
#img1 = datamat[201]
datamat = np.load("../../imagenet_%d.npy"%256,mmap_mode='r')
img1 = imread("../../imgnet_32/n03933933_1353.JPEG")
imsave("original.JPEG",img1)
img1 = datamat[201]
...
targetfeat = np.load("../../imgnet_32/n03933933_1353feats.npz")
...
# In[31]:
#foldername="bench489tobridge351"
num_iter = 20000
...
for i in range(5):
    ...
    #parano.append(np.load("./para_%d_%d.npy"%(st_load,i)))
    realgrad.append(0.0)
...
for i in range(st_iter,st_iter+num_iter):
    ...
    if i==14000: 
        lr=0.001
        for j in range(5):
            vgg.loss_am[j]=1000*vgg.posloss+1*vgg.negloss[j]+100*vgg.diffnorm
    for j in range(5):
