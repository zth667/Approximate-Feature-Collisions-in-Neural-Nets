...
vgg = vgg16(paras,'../../imgnet_32/imagenet_n02708093_107_overlap.npz', '../vgg16_weights.npz', sess)
...
targetfeat = np.load("../n03291819_1620feats.npz")
...
# In[31]:
foldername="clock107toenvelope1620"
num_iter = 20000
